  ...
  return (
    <footer>
      ...
      <div style={{width:'100%', paddingTop:'20px', borderTop:'1px solid var(--border)', marginTop:'4px'}}>
        <p style={{fontSize:'11px', color:'var(--text-dim)', marginBottom:'8px'}}>Avalon Capital Group (Pty) Ltd &middot; Reg. No. 2025/671885/07 &middot; Pietermaritzburg, KwaZulu-Natal, South Africa &middot; <a href="mailto:hello@avaloncapitalgroup.co.za" style={{color:'var(--text-dim)', textDecoration:'none'}}>hello@avaloncapitalgroup.co.za</a></p>
        ...
        <p style={{fontSize:'11px', color:'var(--text-dim)', marginTop:'12px'}}>Avalon Capital Group. <Link href="/vantara" style={{color:'var(--text-dim)', textDecoration:'none'}}>Vantara</Link> and <Link href="/ada" style={{color:'var(--text-dim)', textDecoration:'none'}}>ADA</Link> are divisions of this business.</p>
      </div>
    </footer>
  );
}
