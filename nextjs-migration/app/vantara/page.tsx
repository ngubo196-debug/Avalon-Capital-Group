    ...
    <>
      ...
      <div id="page-vantara" className="page" role="main">
        ...
        <div className="inner-hero">
          ...
          <Link className="back-btn" href="/" style={{position:'relative', zIndex:9999}}>← Back to Avalon Capital Group</Link>
          <img src="/assets/acg-logo.jpg" alt="Vantara" style={{height:'150px', marginBottom:'24px', display:'block', objectFit:'contain', mixBlendMode:'screen', position:'relative', zIndex:2}} />
