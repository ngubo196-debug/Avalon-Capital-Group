    ...
    <>
      ...
      <div id="page-vantara" className="page" role="main">
        ...
        <div className="inner-hero">
          ...
          <img src="/assets/vantara-hero.png" alt="Vantara" style={{height:'80px', width:'auto', objectFit:'contain', marginBottom:'24px', position:'relative', zIndex:2, display:'block', mixBlendMode:'screen'}} />
