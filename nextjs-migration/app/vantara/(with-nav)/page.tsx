  ...
  return (
    <>
      ...
      <div className="vantara-home-page">
        ...
        .wds-mandate-price { color: var(--v-ink) !important; font-style: normal; border-bottom: none !important; padding-top: 14px !important; }
        .wds-mandate-link { display: inline-flex; align-items: center; gap: 8px; margin-top: 20px; font-family: DM Sans, sans-serif; font-size: 12px; font-weight: 400; letter-spacing: 0.08em; text-transform: uppercase; color: var(--v-ink); text-decoration: none; border-bottom: 1px solid var(--v-ink); padding-bottom: 2px; }
