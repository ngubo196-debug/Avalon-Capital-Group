...
export const metadata: Metadata = {
  title: 'Websites for Fleet Companies in South Africa | ADA',
  description: 'Your fleet has the capacity. Your website should prove it. ADA builds sites that win procurement trust before the first call.',
...
export default function WebDesignFleetCompanies() {
  return (
    <div id="page-web-design-fleet-companies" className="page ada-section" role="main">
      ...
      <section className="wds-section wds-section--wash" aria-labelledby="problem-heading">
        <div className="wds-inner">
          ...
          <h2 className="wds-h2" id="problem-heading">Procurement teams vet suppliers online before they call anyone.</h2>
          <p className="wds-body">A logistics manager needs a new fleet maintenance partner. A corporate buyer is sourcing vehicle hire for 50 staff. A supply chain operator wants to add a transport contractor to their approved list.</p>
          ...
          <p className="wds-body">If your average fleet contract is worth R200,000 a year and you miss even two qualified enquiries a month, that is R400,000 in annual contract value going to a competitor. Not because their fleet is better. Because their website is.</p>
        </div>
      </section>
      ...
      <section className="wds-section wds-section--white" aria-labelledby="changes-heading">
        <div className="wds-inner">
          ...
          <h2 className="wds-h2" id="changes-heading">A site that earns contract-level trust before the first conversation.</h2>
          <p className="wds-body">Fleet capability documented. Contract history visible. Service coverage across South Africa structured so procurement teams find you and trust you before they pick up the phone.</p>
      ...
      <section className="wds-section wds-section--wash" aria-labelledby="proof-heading">
        <div className="wds-inner">
          ...
          <p className="wds-body">Afripact Civils had the completed projects and the credentials. Nothing online showed it. Within weeks of the rebuild, inspection requests were coming from people who had never heard of them before. The same gap exists in fleet. The same fix applies.</p>
      ...
      <section className="wds-section wds-section--white" aria-labelledby="for-heading">
        <div className="wds-inner">
          ...
          <h2 className="wds-h2" id="for-heading">Built for established fleet operators. Not for everyone.</h2>
          <p className="wds-body">Five or more years operating. Real contracts. Real fleet capacity. Looking to win larger or better-quality clients. If that is not you, this is not the right fit.</p>
