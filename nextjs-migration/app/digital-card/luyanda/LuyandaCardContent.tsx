...
export default function LuyandaCardContent() {
  ...
  function saveContact() {
    const vcard = [
      ...
      'TITLE:Founder',
      'TEL;TYPE=CELL,VOICE:+27712205313',
      'TEL;TYPE=CELL,WHATSAPP:+27712205313',
    ...
    a.href = url;
    a.download = 'Luyanda-Ngubo-ACG.vcf';
      ...
      <div className="card-root">
        <div className="card">
          ...
          <div className="card-header">
            ...
            <div className="person-name">Luyanda Ngubo</div>
            <div className="person-title">Founder</div>
          ...
          <div className="card-body">
            <div className="contact-row">
              ...
              <div>
                ...
                <div className="contact-value">+27 71 220 5313</div>
              </div>
            </div>
            ...
            <div className="contact-row">
              ...
              <div>
                ...
                <div className="contact-value">luyanda@avaloncapitalgroup.co.za</div>
              </div>
            </div>
          ...
          <div className="card-actions">
            <a className="action-btn btn-whatsapp" href="https://wa.me/27712205313">
            ...
            <a className="action-btn btn-call" href="tel:+27712205313">
            ...
            <a className="action-btn btn-email" href="mailto:luyanda@avaloncapitalgroup.co.za">
